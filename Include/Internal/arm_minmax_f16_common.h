 ...
 * Description:  Shared float16 min/max declarations
 *
 * $Date:        19 March 2026
 * $Revision:    V.1.0.0
 *
...
/**
 * @brief Shared implementation for arm_minimum_f16 / arm_maximum_f16.
 *
 * Defined out-of-line in arm_minmax_f16_common.c (rather than inline in this
