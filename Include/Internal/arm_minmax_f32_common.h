 ...
 * Description:  Shared float32 min/max helper templates
 *
 * $Date:        19 March 2026
 * $Revision:    V.1.0.0
 *
...
__STATIC_INLINE int32_t arm_check_broadcast_required_f32(const cmsis_nn_dims *shape_1, const cmsis_nn_dims *shape_2)
{
...
__STATIC_INLINE float32_t arm_minmax_select_f32(float32_t a, float32_t b, int32_t select_max)
{
    return (a >= b) ? (select_max ? a : b) : (select_max ? b : a);
}

__STATIC_INLINE arm_cmsis_nn_status arm_minmax_no_broadcast_f32(const float32_t *input_1,
...
__STATIC_INLINE arm_cmsis_nn_status arm_minmax_scalar_f32(const float32_t *input_1,
                                                          const float32_t *input_2,
                                                          float32_t *output,
                                                          int32_t flat_size,
                                                          int32_t select_max)
...
__STATIC_INLINE arm_cmsis_nn_status arm_minmax_f32_impl(const cmsis_nn_context *ctx,
                                                        ...
                                                        int32_t select_max)
{
    ...
    if (arm_check_broadcast_required_f32(input_1_dims, input_2_dims))
    {
        if (flat_size_1 == 1)
        {
            arm_minmax_scalar_f32(input_1_data, input_2_data, output_data, flat_size_2, select_max);
        }
        else if (flat_size_2 == 1)
        {
            arm_minmax_scalar_f32(input_2_data, input_1_data, output_data, flat_size_1, select_max);
        }
        else
        {
            ...
            {
                const float32_t *input_1_ptr = input_1_data;
                const float32_t *input_2_ptr = input_2_data;
                ...
                {
                    arm_minmax_no_broadcast_f32(input_1_ptr, input_2_ptr, output_data, flat_size_1, select_max);
    ...
    {
        arm_minmax_no_broadcast_f32(input_1_data, input_2_data, output_data, flat_size_1, select_max);
    }
