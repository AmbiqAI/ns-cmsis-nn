...
set(CMAKE_TRY_COMPILE_PLATFORM_VARIABLES TARGET_CPU LLVM_ET_ARM_DIR)
...
elseif(TARGET_CPU STREQUAL "cortex-m4")
  set(LLVM_ET_ARM_ARCH_FLAGS "-mthumb -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard")
elseif(TARGET_CPU STREQUAL "cortex-m55")
  set(LLVM_ET_ARM_ARCH_FLAGS "-mthumb -march=armv8.1-m.main+mve.fp -mfloat-abi=hard")
else()
