...
def _build_cases() -> list[PoolingCaseFlt]:
    return [
        ...
        # 1D max pooling coverage (mirrors upstream CMSIS-NN maxpooling_1d_* cases).
        PoolingCaseFlt(
            dataset="maxpooling_1d_k2s2_clip_f32",
            dtype_name="f32",
            torch_dtype=torch.float32,
            op_name="maxpool",
            batches=1,
        ...
        PoolingCaseFlt(
            dataset="maxpooling_1d_k2s2_clip_f16",
            dtype_name="f16",
            torch_dtype=torch.float16,
            op_name="maxpool",
            batches=1,
        ...
        PoolingCaseFlt(
            dataset="maxpooling_1d_k2s2_noclip_f32",
            dtype_name="f32",
            torch_dtype=torch.float32,
            op_name="maxpool",
            batches=1,
        ...
        PoolingCaseFlt(
            dataset="maxpooling_1d_k2s2_noclip_f16",
            dtype_name="f16",
            torch_dtype=torch.float16,
            op_name="maxpool",
            batches=1,
        ...
        PoolingCaseFlt(
            dataset="maxpooling_1d_k3s3_noclip_f32",
            dtype_name="f32",
            torch_dtype=torch.float32,
            op_name="maxpool",
            batches=1,
        ...
        PoolingCaseFlt(
            dataset="maxpooling_1d_k3s3_noclip_f16",
            dtype_name="f16",
            torch_dtype=torch.float16,
            op_name="maxpool",
            batches=1,
