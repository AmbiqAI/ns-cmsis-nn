...
void slice_f16_arm_strided_slice_f16(void)
{
    ...
    const cmsis_nn_dims stride_dims = {SLICE_F16_STRIDES_N, SLICE_F16_STRIDES_H, SLICE_F16_STRIDES_W,
                                       SLICE_F16_STRIDES_C};
    const cmsis_nn_dims output_dims = {SLICE_F16_OUTPUT_N, SLICE_F16_OUTPUT_H, SLICE_F16_OUTPUT_W, SLICE_F16_OUTPUT_C};

    TEST_ASSERT_EQUAL(ARM_CMSIS_NN_SUCCESS,
                      arm_strided_slice_f16(slice_f16_input, output, &input_dims, &begin_dims, &stride_dims,
                                            &output_dims));
