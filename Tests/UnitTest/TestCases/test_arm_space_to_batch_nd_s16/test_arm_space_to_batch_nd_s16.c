...
#include "../TestData/space_to_batch_nd_basic_2x2_s16/test_data.h"
#include "../TestData/space_to_batch_nd_nsquare_pad_s16/test_data.h"
#include "../TestData/space_to_batch_nd_batch_s16/test_data.h"
#include "../TestData/space_to_batch_nd_both_pad_s16/test_data.h"
#include "../TestData/space_to_batch_nd_small_pad_s16/test_data.h"
#include "../TestData/space_to_batch_nd_bs1_identity_pad_s16/test_data.h"

#ifndef REPEAT_NUM
#define REPEAT_NUM (1)
#endif

/* NAME_UP: upper-snake macro prefix (e.g. SPACE_TO_BATCH_ND_BASIC_2X2_S16)
 * name_lc: lower-snake array prefix (e.g. space_to_batch_nd_basic_2x2_s16)
 *
...
#define GEN_S2BND_TEST(NAME_UP, name_lc)                                                       \
    void name_lc##_arm_space_to_batch_nd_s16(void)                                              \
    {                                                                                          \
...
/* Instantiate tests */
GEN_S2BND_TEST(SPACE_TO_BATCH_ND_BASIC_2X2_S16,        space_to_batch_nd_basic_2x2_s16)
GEN_S2BND_TEST(SPACE_TO_BATCH_ND_NSQUARE_PAD_S16,      space_to_batch_nd_nsquare_pad_s16)
GEN_S2BND_TEST(SPACE_TO_BATCH_ND_BATCH_S16,            space_to_batch_nd_batch_s16)
GEN_S2BND_TEST(SPACE_TO_BATCH_ND_BOTH_PAD_S16,         space_to_batch_nd_both_pad_s16)
GEN_S2BND_TEST(SPACE_TO_BATCH_ND_SMALL_PAD_S16,        space_to_batch_nd_small_pad_s16)
GEN_S2BND_TEST(SPACE_TO_BATCH_ND_BS1_IDENTITY_PAD_S16, space_to_batch_nd_bs1_identity_pad_s16)
