...
void sub_broadcast_batch_scalar_s16_arm_sub_s16(void)
{
    const int16_t input_1[2] = {10, 20};
    const int16_t input_2[4] = {1, 2, 3, 4};
    const int16_t expected_1_2[8] = {9, 8, 7, 6, 19, 18, 17, 16};
    const int16_t expected_2_1[8] = {-9, -8, -7, -6, -19, -18, -17, -16};
    int16_t output[8] = {0};
...
void sub_dims_arg_error_s16_arm_sub_s16(void)
{
