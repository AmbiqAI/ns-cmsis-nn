...
#include "../TestData/batch_to_space_nd_basic_2x2_s16/test_data.h"
#include "../TestData/batch_to_space_nd_nsquare_crops_s16/test_data.h"
#include "../TestData/batch_to_space_nd_batch_s16/test_data.h"
#include "../TestData/batch_to_space_nd_both_crops_s16/test_data.h"
#include "../TestData/batch_to_space_nd_bs1_identity_s16/test_data.h"

#ifndef REPEAT_NUM
#define REPEAT_NUM (1)
#endif

/* NAME_UP: upper-snake macro prefix (e.g. BATCH_TO_SPACE_ND_BASIC_2X2_S16)
 * name_lc: lower-snake array prefix (e.g. batch_to_space_nd_basic_2x2_s16)
 *
...
#define GEN_B2SND_TEST(NAME_UP, name_lc)                                                     \
    void name_lc##_arm_batch_to_space_nd_s16(void)                                            \
    {                                                                                        \
...
/* Instantiate tests */
GEN_B2SND_TEST(BATCH_TO_SPACE_ND_BASIC_2X2_S16,        batch_to_space_nd_basic_2x2_s16)
GEN_B2SND_TEST(BATCH_TO_SPACE_ND_NSQUARE_CROPS_S16,    batch_to_space_nd_nsquare_crops_s16)
GEN_B2SND_TEST(BATCH_TO_SPACE_ND_BATCH_S16,            batch_to_space_nd_batch_s16)
GEN_B2SND_TEST(BATCH_TO_SPACE_ND_BOTH_CROPS_S16,       batch_to_space_nd_both_crops_s16)
GEN_B2SND_TEST(BATCH_TO_SPACE_ND_BS1_IDENTITY_S16,     batch_to_space_nd_bs1_identity_s16)
