...
class Op_elementwise_mul(Lib.op_utils.Op_type):

    def get_shapes(params):
        shapes = {}
        shapes["lhs_input_tensor"] = (params["lhs_batch"], params["lhs_rows"], params["lhs_cols"])
        shapes["rhs_input_tensor"] = (params["rhs_batch"], params["rhs_rows"], params["rhs_cols"])
        shapes["representational_dataset"] = (params["lhs_batch"], params["lhs_rows"], params["lhs_cols"])
        shapes["representational_dataset2"] = (params["rhs_batch"], params["rhs_rows"], params["rhs_cols"])
    ...
    def generate_keras_model(shapes, params):
        ...
        layer = tf.math.multiply(input_lhs, input_rhs)
