...
- Host targets: none (`test_arm_convolve_f32` deleted in #256,
  `test_arm_convolve_f16` deleted as unbuildable, never CI-built; f16
  convolution is covered by helia-core-tester and
  `test_arm_convolve_packed_f16`)
- CMSIS project: none (`test_arm_convolve_flt` deleted with its only suite)
- CMSIS contexts: none
- Covered cases (as generated by `conv_settings_flt.py`):
