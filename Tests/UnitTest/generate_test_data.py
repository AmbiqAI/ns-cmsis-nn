...
RSQRT_TEST_TYPE = "rsqrt"
RSQRT_DATASET_NAME = "rsqrt_s16"
...
def is_local_testdata_set(testset_name: str) -> bool:
    """Return whether a dataset is generated by a local helper instead of the settings registry."""
    return testset_name == RSQRT_DATASET_NAME
...
def load_testdata_sets(regenerate_input, regenerate_weights, regenerate_biases, schema_file, interpreter) -> dict:
    ...
    dataset = 'int16xint8_group_depthwise'
    testdata_sets[dataset] = ConvSettings(dataset,
                                          type_of_test,
                                          regenerate_weights,
                                          regenerate_input,
    ...
    dataset = 'int16xint8_group_depthwise_3x3'
    testdata_sets[dataset] = ConvSettings(dataset,
                                          type_of_test,
                                          regenerate_weights,
                                          regenerate_input,
    ...
    dataset = 'int16xint8_group_depthwise_3x3_pad'
    testdata_sets[dataset] = ConvSettings(dataset,
                                          type_of_test,
                                          regenerate_weights,
                                          regenerate_input,
    ...
    dataset = 'int16xint8_group_depthwise_3x3_stride_dilation'
    testdata_sets[dataset] = ConvSettings(dataset,
                                          type_of_test,
                                          regenerate_weights,
                                          regenerate_input,
...
def main():
    ...
    if args.run_all_testsets:
        ...
        if not test_type or test_type == RSQRT_TEST_TYPE:
            print("Generating testset {}..".format(RSQRT_DATASET_NAME))
            generate_rsqrt_test_data()
            print()
        ...
        for testset_name in found_test_data_sets:
            if testset_name not in testdata_sets and not is_local_testdata_set(testset_name):
                print("WARNING: Testset {} in {} was not loaded".format(testset_name, directory))
    elif testdataset:
        if testdataset == RSQRT_DATASET_NAME or test_type == RSQRT_TEST_TYPE:
            if testdataset != RSQRT_DATASET_NAME:
                raise RuntimeError("RSQRT top-level generation uses dataset name '{}'".format(RSQRT_DATASET_NAME))
            generate_rsqrt_test_data()
            return 0
