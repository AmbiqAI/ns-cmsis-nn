...
class OpTanh(OperationBase):
    ...
    def generate_c_files(self, output_dir: Path) -> None:
        ...
        from cmsis_nn_tools.generation.tflite_generator.tester.utils.tflite_utils import calculate_multiplier_shift
        ...
        from cmsis_nn_tools.generation.tflite_generator.tester.utils.litert_utils import get_operator_tensors_from_litert
