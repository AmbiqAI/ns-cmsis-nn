...
from cmsis_nn_tools.core.discovery import find_repo_root, find_setup_dependencies_script
...
def run_tests_with_reporting(cpus: List[str], 
    ...
    from cmsis_nn_tools.reporting.models import TestReport, TestStatus, DescriptorResult
