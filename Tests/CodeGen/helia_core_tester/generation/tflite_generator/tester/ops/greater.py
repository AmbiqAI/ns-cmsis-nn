"""
Greater comparison operation implementation.
"""
...
class OpGreater(OperationBase):
    """
    Greater comparison operation.
    """
    
    def build_keras_model(self) -> tf.keras.Model:
        """Build Keras model for Greater operation."""
        ...
        # Greater operation outputs boolean
        output = tf.keras.layers.Lambda(lambda x: tf.greater(x[0], x[1]))([input1, input2])
    ...
    def generate_c_files(self, output_dir) -> None:
        """
        Generate C and H files - not yet implemented for Greater.
        """
        pass
