...
class OperationBase(ABC):
    ...
    def load_litert_interpreter(self, tflite_path: str):
        ...
        """
        from helia_core_tester.generation.tflite_generator.tester.utils.litert_utils import load_litert_interpreter
    ...
    def load_litert_model(self, tflite_path: str, subgraph_index: int = 0):
        ...
        """
        from helia_core_tester.generation.tflite_generator.tester.utils.litert_utils import load_litert_model
