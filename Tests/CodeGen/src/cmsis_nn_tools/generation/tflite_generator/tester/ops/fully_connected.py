...
class OpFullyConnected(OperationBase):
    ...
    def _compute_fixed_point_multipliers(
        ...
        """
        from helia_core_tester.generation.tflite_generator.tester.utils.tflite_utils import calculate_per_channel_multiplier_shift
        ...
        if activation_dtype == 'S16' and len(multipliers) > 1:
            from helia_core_tester.generation.tflite_generator.tester.utils.tflite_utils import reduce_multiplier_q31_to_q15
    ...
    def generate_c_files(self, output_dir: Path) -> None:
        ...
        from helia_core_tester.generation.tflite_generator.tester.utils.litert_utils import (
        ...
        from helia_core_tester.generation.tflite_generator.tester.utils.litert_utils import run_inference_litert
