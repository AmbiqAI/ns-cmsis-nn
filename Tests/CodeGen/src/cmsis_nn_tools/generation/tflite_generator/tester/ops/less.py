"""
Less comparison operation implementation.
"""
...
class OpLess(OperationBase):
    """
    Less comparison operation.
    """
    
    def build_keras_model(self) -> tf.keras.Model:
        """Build Keras model for Less operation."""
        ...
        # Less operation outputs boolean
        output = tf.keras.layers.Lambda(lambda x: tf.less(x[0], x[1]))([input1, input2])
    ...
    def generate_c_files(self, output_dir) -> None:
        """
        Generate C and H files - not yet implemented for Less.
        """
        pass
