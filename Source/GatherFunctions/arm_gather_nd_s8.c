 ...
 * Title:        arm_gather_nd_s8.c
 * Description:  Gather_nd operator implementations for s8 tensors.
 *
                                     ...
                                     const cmsis_nn_dims *output_dims)
{
    ...
    for (size_t batch = 0; batch < batch_count; ++batch)
    {
        ...
        for (size_t slice = 0; slice < n_slices_per_batch; ++slice)
        {
            ...
            arm_memcpy_s8(output_data + (batch * n_slices_per_batch + slice) * slice_size,
