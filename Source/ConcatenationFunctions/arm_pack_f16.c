 ...
 * Title:        arm_pack_f16.c
 * Description:  Stack float16_t tensors along a new axis (any rank)
 *
                                 ...
                                 float16_t *output_data)
{
    ...
    arm_nn_axis_gather_f16(input_data, outer, num_inputs, NULL, inner, output_data);
