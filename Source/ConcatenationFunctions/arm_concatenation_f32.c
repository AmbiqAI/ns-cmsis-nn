 ...
 * Description:  Concatenation operators for float32 tensors
 *
 * $Date:        19 March 2026
 * $Revision:    V.1.0.0
 *
...
ARM_CONCATENATION_DEFINE(f32, float32_t)
                                          ...
                                          float32_t *output_data)
{
    ...
    arm_nn_axis_gather_f32(input_data, outer, num_inputs, axis_sizes, inner, output_data);
