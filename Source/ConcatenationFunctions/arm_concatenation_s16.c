 ...
 * Title:        arm_concatenation_s16.c
 * Description:  Concatenate s16 vectors
 *
                                          ...
                                          const int32_t *output_shape)
{
    ...
    for (int k = 0; k < outer_size; k++)
    {
        ...
        for (int i = 0; i < inputs_count; i++)
        {
            ...
            const int16_t *in_ptr = input_data[i] + k * copy_size;
            arm_memcpy_s16(output_data, in_ptr, copy_size);
