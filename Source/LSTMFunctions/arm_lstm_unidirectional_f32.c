                                                ...
                                                cmsis_nn_lstm_context_f32 *buffers)
{
    ...
    else
    {
        ...
        // forces one batch at a time (arm_nn_lstm_step_f32 shares a batch_offset for data_in
        // and hidden_in).
        ...
        {
            float32_t *step_hidden_in = buffers->hidden_state + (size_t)b * (size_t)params->hidden_size;
