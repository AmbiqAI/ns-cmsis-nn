 ...
 * Title:        arm_add_scalar_s8
 * Description:  Elementwise add with scalar input
 *
 * $Date:        23 May 2025
 * $Revision:    V.1.0.0
 *
                                      ...
                                      const int32_t block_size)
{
    ...
    int32x4_t vect_1 = vdupq_n_s32(scalar_val);
