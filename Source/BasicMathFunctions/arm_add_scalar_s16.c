                                       ...
                                       const int32_t block_size)
{
    ...
    const int32_t scalar_val = input_1_vect[0];
    ...
    while (count > 0)
    {
        ...
        int32x4_t rst = vaddq_s32(vect_1, vect_2);
    ...
    int32_t input_2;
    int32_t sum;
    int32_t two_halfword_2;
    int16_t sum_1, sum_2;
    int32_t loop_count = block_size / 2;

    input_1 = input_1_vect[0] * (int32_t)((uint32_t)1 << left_shift);
