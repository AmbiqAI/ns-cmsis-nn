...
#define ARM_MUL_S16_FULL(a, b, o, n)                                                                                   \
    arm_elementwise_mul_s16((a),                                                                                       \
                            (b),                                                                                       \
                            input1_offset,                                                                             \
                            input2_offset,                                                                             \
                            (o),                                                                                       \
                            ...
                            out_activation_max,                                                                        \
                            (n))
#define ARM_MUL_S16_SCALAR_1(s, v, o, n)                                                                               \
    arm_mul_scalar_s16((s),                                                                                            \
                       (v),                                                                                            \
                       input1_offset,                                                                                  \
                       input2_offset,                                                                                  \
                       (o),                                                                                            \
                       ...
                       out_activation_max,                                                                             \
                       (n))
#define ARM_MUL_S16_SCALAR_2(s, v, o, n)                                                                               \
    arm_mul_scalar_s16((s),                                                                                            \
                       (v),                                                                                            \
                       input2_offset,                                                                                  \
                       input1_offset,                                                                                  \
...
/*
 * s16 elementwise mul w/ support for broadcasting and scalar
 *
                                ...
                                const int32_t out_activation_max)
{
    ...
    ARM_NN_BROADCAST_WALK_NHWC(int16_t,
                               ...
                               output_dims,
                               ARM_MUL_S16_FULL,
                               ARM_MUL_S16_SCALAR_1,
                               ARM_MUL_S16_SCALAR_2);

    return ARM_CMSIS_NN_SUCCESS;
}

#undef ARM_MUL_S16_FULL
#undef ARM_MUL_S16_SCALAR_1
#undef ARM_MUL_S16_SCALAR_2
