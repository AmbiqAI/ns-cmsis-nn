                                   ...
                                   const cmsis_nn_dims *output_dims)
{
    ...
    if (arm_check_broadcast_required(input_1_dims, input_2_dims))
    {
        ...
        {
            // arm_max_scalar expects the tensor with the scalar value to be provided first
            arm_max_scalar_s16(input_2_data, input_1_data, output_data, flat_size_1);
        }
        else
        {
            ...
            for (int32_t i_out_batch = 0; i_out_batch < output_batch; i_out_batch++)
            {
                ...
                {
                    arm_max_no_broadcast_s16(input_1_ptr, input_2_ptr, output_data, flat_size_1);
                    ...
                    for (int32_t i_out_height = 0; i_out_height < output_height; i_out_height++)
                    {
                        ...
                        else
                        {
                            for (int32_t i_out_width = 0; i_out_width < output_width; i_out_width++)
                            {
                                ...
                                {
                                    arm_max_no_broadcast_s16(input_1_ptr, input_2_ptr, output_data, input_1_channels);
                                ...
                                {
                                    // arm_max_scalar expects the tensor with the scalar value to be provided first
                                    arm_max_scalar_s16(input_1_ptr, input_2_ptr, output_data, input_2_channels);
                                ...
                                {
                                    // arm_max_scalar expects the tensor with the scalar value to be provided first
                                    arm_max_scalar_s16(input_2_ptr, input_1_ptr, output_data, input_1_channels);
                                    output_data += input_1_channels;
                                    input_1_ptr += input_1_channels;
                                    input_2_ptr++;
                                }
    ...
    {
        arm_max_no_broadcast_s16(input_1_data, input_2_data, output_data, flat_size_1);
    }
