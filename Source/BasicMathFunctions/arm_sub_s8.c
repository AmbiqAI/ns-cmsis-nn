...
/*
 * s8 elementwise subtract w/ support for broadcasting and scalar
 *
                               ...
                               const int32_t out_activation_max)
{
    ...
    {
        return arm_elementwise_sub_s8(input1_data,
                                      input2_data,
                                      input1_offset,
                                      input1_mult,
                                      input1_shift,
    ...
    if (flat1_total == 1)
    {
        return arm_sub_scalar_s8(input1_data,
                                 input2_data,
                                 input1_offset,
                                 input1_mult,
                                 input1_shift,
    ...
    if (flat2_total == 1)
    {
        return arm_rsub_scalar_s8(input1_data,
                                  input2_data,
                                  input1_offset,
                                  input1_mult,
                                  input1_shift,
            ...
            for (int h = 0; h < out_h; h++)
            {
                ...
                else
                {
                    for (int w = 0; w < out_w; w++)
                    {
                        ...
                        // 2) scalar-broadcast1 (input1 channel == 1)
                        else if (in1_c == 1)
                        {
                            arm_sub_scalar_s8(p1,
                                              p2,
                        ...
                        // 3) scalar-broadcast2 (input2 channel == 1)
                        else // in2_c == 1
                        {
                            arm_rsub_scalar_s8(p1,
                                               p2,
