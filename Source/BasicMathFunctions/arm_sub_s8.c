...
#define ARM_SUB_S8_FULL(a, b, o, n)                                                                                    \
    arm_elementwise_sub_s8((a),                                                                                        \
                           (b),                                                                                        \
                           input1_offset,                                                                              \
                           input1_mult,                                                                                \
                           input1_shift,                                                                               \
                           ...
                           out_activation_max,                                                                         \
                           (n))
#define ARM_SUB_S8_SCALAR_1(s, v, o, n)                                                                                \
    arm_sub_scalar_s8((s),                                                                                             \
                      (v),                                                                                             \
                      input1_offset,                                                                                   \
                      input1_mult,                                                                                     \
                      ...
                      out_activation_max,                                                                              \
                      (n))
#define ARM_SUB_S8_SCALAR_2(s, v, o, n)                                                                                \
    arm_rsub_scalar_s8((v),                                                                                            \
                       (s),                                                                                            \
                       input1_offset,                                                                                  \
                       input1_mult,                                                                                    \
                       input1_shift,                                                                                   \
...
#undef ARM_SUB_S8_FULL
#undef ARM_SUB_S8_SCALAR_1
#undef ARM_SUB_S8_SCALAR_2
