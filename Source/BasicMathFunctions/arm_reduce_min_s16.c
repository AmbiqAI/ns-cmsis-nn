 ...
 */
arm_cmsis_nn_status
arm_reduce_min_spatial_s16(const int16_t *input_data,
                           const cmsis_nn_dims *input_dims,
                           const cmsis_nn_dims *axis_dims,
                           int16_t *output_data,
                           const cmsis_nn_dims *output_dims)
{
    ...
    return arm_reduce_min_generic_s16(input_data,
                                     input_dims,
                                     axis_dims,
                                     output_data,
                                     output_dims);
                                      ...
                                      const cmsis_nn_dims *output_dims)
{
    ...
    if (suffix_start >= 0)
    {
        ...
        return arm_reduce_min_flatten_last_dims_s16(input_data,
                                                    output_data,
                                                    outer_size,
                                                    inner_size);
    }
    ...
    {
        return arm_reduce_min_spatial_s16(input_data,
                                          input_dims,
                                          axis_dims,
                                          output_data,
                                          output_dims);
