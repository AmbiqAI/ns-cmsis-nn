                               ...
                               const int32_t out_activation_max)
{
    ...
    {
        return arm_elementwise_add_s8(input1_data,
                                      input2_data,
                                      input1_offset,
                                      input1_mult,
                                      input1_shift,
    ...
    if (flat1_total == 1)
    {
        return arm_add_scalar_s8(input1_data,
                                 input2_data,
                                 input1_offset,
                                 input1_mult,
                                 input1_shift,
    ...
    if (flat2_total == 1)
    {
        return arm_add_scalar_s8(input2_data,
                                 input1_data,
                                 input2_offset,
                                 input2_mult,
                                 input2_shift,
