                                ...
                                const int32_t out_activation_max)
{
    ...
    {
        return arm_elementwise_sub_s16(input1_data,
                                       input2_data,
                                       input1_offset,
                                       input1_mult,
                                       input1_shift,
    ...
    if (flat1_total == 1)
    {
        return arm_sub_scalar_s16(input1_data,
                                  input2_data,
                                  input1_offset,
                                  input1_mult,
                                  input1_shift,
    ...
    if (flat2_total == 1)
    {
        return arm_rsub_scalar_s16(input1_data,
                                   input2_data,
                                   input1_offset,
                                   input1_mult,
                                   input1_shift,
