                                          ...
                                          const cmsis_nn_dims *const output_dims)
{
        ...
        b_c == 0 && o_c == in_c)
    {
        ...
        arm_memcpy_s16(output_data, input_data + offset, total);
    ...
    if (s_h == 1 && s_w == 1 && s_c == 1 && b_w == 0 && o_w == in_w && b_c == 0 && o_c == in_c)
    {
        ...
        for (int32_t n = 0; n < o_n; n++)
        {
            ...
            arm_memcpy_s16(output_data + n * batch_block, input_data + start, batch_block);
        }
        return ARM_CMSIS_NN_SUCCESS;
    }
    ...
    if (s_w == 1 && s_c == 1 && b_c == 0 && o_c == in_c)
    {
        ...
        for (int32_t n = 0; n < o_n; n++)
        {
            ...
            for (int32_t h = 0; h < o_h; h++)
            {
                ...
                arm_memcpy_s16(output_data + out_idx, input_data + start, row_block);
                out_idx += row_block;
            }
        }
        return ARM_CMSIS_NN_SUCCESS;
        ...
        for (int32_t n = 0; n < o_n; n++)
        {
            ...
            for (int32_t h = 0; h < o_h; h++)
            {
                ...
                for (int32_t w = 0; w < o_w; w++)
                {
                    ...
                    arm_memcpy_s16(output_data + out_idx, input_data + start, o_c);
                    out_idx += o_c;
                }
            }
        }
