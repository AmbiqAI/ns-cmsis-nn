 ...
 * Title:        arm_resize_nearest_neighbor_s8.c
 * Description:  Resize nearest neighbor for s8 tensors
 *
 * $Date:        5 January 2025
 * $Revision:    V.1.0.2
 *
...
/*
 * Basic s8 resize nearest neighbor function.
 *
    ...
    for (int b = 0; b < batches; ++b) {
        for (int y = 0; y < output_height; ++y) {
            ...
            for (int x = 0; x < output_width; ++x) {
                ...
                arm_memcpy_s8(output_ptr, x_input_ptr, depth * sizeof(int8_t));
                output_ptr += depth;
            }
        }
