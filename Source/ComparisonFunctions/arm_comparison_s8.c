...
#define ARM_COMPARE_FULL_S8(a, b, o, n)                                                                                \
    arm_compare_no_broadcast_s8((a), (b), (o), (n), &input_1_params, &input_2_params, left_shift, operation)
#define ARM_COMPARE_SCALAR_1_S8(s, v, o, n)                                                                            \
    arm_compare_scalar_broadcast_s8(*(s), &input_1_params, (v), &input_2_params, (o), (n), left_shift, true, operation)
#define ARM_COMPARE_SCALAR_2_S8(s, v, o, n)                                                                            \
    arm_compare_scalar_broadcast_s8(*(s), &input_2_params, (v), &input_1_params, (o), (n), left_shift, false, operation)
                                      ...
                                      const arm_nn_compare_operation operation)
{
    ...
    ARM_NN_BROADCAST_WALK_NHWC(int8_t,
                               ...
                               output_dims,
                               ARM_COMPARE_FULL_S8,
                               ARM_COMPARE_SCALAR_1_S8,
                               ARM_COMPARE_SCALAR_2_S8);

    return ARM_CMSIS_NN_SUCCESS;
}

#undef ARM_COMPARE_FULL_S8
#undef ARM_COMPARE_SCALAR_1_S8
#undef ARM_COMPARE_SCALAR_2_S8
