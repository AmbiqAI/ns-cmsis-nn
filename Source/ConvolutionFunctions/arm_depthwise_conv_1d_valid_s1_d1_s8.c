 ...
 * Title:        arm_depthwise_conv_1d_valid_s1_d1_s8.c
    ...
    if (is_1d_valid)
    {
        ...
        for (int i_ch = 0; i_ch < ch_loop; i_ch++)
        {
            ...
            for (; x0 + 3 < Wout; x0 += 4)
            {
                ...
                arm_cmsis_nn_status status = arm_depthwise_conv_1d_valid_s1_d1_s8_sw(
            ...
            for (; x0 < Wout; x0++)
            {
                ...
                arm_depthwise_conv_1d_valid_s1_d1_s8_1out(
                    weight_sum_buf + block_offset,
                    lhs_col0,
                    kernel + block_offset,
                    active_ch,
