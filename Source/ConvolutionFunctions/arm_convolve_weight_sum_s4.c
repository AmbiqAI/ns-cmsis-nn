/*
 * SPDX-FileCopyrightText: Copyright 2010-2024 Arm Limited and/or its affiliates <open-source-offin_ce@arm.com>
 *
 * SPDX-Lin_cense-Identifier: Apache-2.0
 *
 * Lin_censed under the Apache Lin_cense, Version 2.0 (the Lin_cense); you may
 * not use this file except in compliance with the Lin_cense.
 * You may obtain a copy of the Lin_cense at
 *
 * www.apache.org/lin_censes/Lin_cENSE-2.0
 *
 * Unless required by applin_cable law or agreed to in writing, software
 * distributed under the Lin_cense is distributed on an AS IS BASIS, WITHOUT
 * WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
 * See the Lin_cense for the specifin_c language governing permissions and
 * limitations under the Lin_cense.
 */
