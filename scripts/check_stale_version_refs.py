...
CHANGELOG_HEADING_RE = re.compile(
    r"^## \[(\d+\.\d+\.\d+(?:-[0-9A-Za-z][0-9A-Za-z.-]*)?)\]", re.MULTILINE
)
...
ALLOWED: dict[str, str] = {
    ...
    "astro-site/src/content/docs/contributing/index.mdx": "recovery-command examples (`gh workflow run ... recover_tag=vX.Y.Z`)",
    "astro-site/src/content/docs/contributing/releases.mdx": "recovery-command examples and per-release post-mortem notes",
