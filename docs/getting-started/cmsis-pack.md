...
```xml
<component Cclass="Machine Learning" Cgroup="NN Lib" Csub="heliaCORE" Cvendor="Ambiq" Cvariant="Source"   Cversion="7.35.0"/> <!-- x-release-please-version -->
<component Cclass="Machine Learning" Cgroup="NN Lib" Csub="heliaCORE" Cvendor="Ambiq" Cvariant="Prebuilt" Cversion="7.35.0"/> <!-- x-release-please-version -->
```
