...
```xml
<component Cclass="Ambiq" Cgroup="NN Lib" Cvariant="Source"   Cversion="7.30.0"/> <!-- x-release-please-version -->
<component Cclass="Ambiq" Cgroup="NN Lib" Cvariant="Prebuilt" Cversion="7.30.0"/> <!-- x-release-please-version -->
```
