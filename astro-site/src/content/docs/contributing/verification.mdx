...
description: What every pull request and release verifies, the qualification model, known limits, and coverage reports.
---
...
[Kernel Benchmarks](/ns-cmsis-nn/guide/performance/kernel-benchmarks/).
...
-- see [CI Matrix](../ci-matrix/).

## Quick links

- Latest release — [https://github.com/AmbiqAI/ns-cmsis-nn/releases/latest](https://github.com/AmbiqAI/ns-cmsis-nn/releases/latest)
- All CI runs — [https://github.com/AmbiqAI/ns-cmsis-nn/actions](https://github.com/AmbiqAI/ns-cmsis-nn/actions)
