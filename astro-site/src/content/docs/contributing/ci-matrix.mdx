---
title: CI Matrix
description: 'One row per CI job: trigger, cores, precisions, whether it executes or only builds, and toolchain versions.'
---
...
[Testing & Verification](../verification/) is the narrative version of the
...
- [Testing & Verification](../verification/), the narrative contract and the
  coverage-report instructions.
- [Versioning & Releases](../releases/), the release asset contract.
