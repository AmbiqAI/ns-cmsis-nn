...
description: Link the relocatable CMake config package shipped in each SDK tarball.
---
...
- Manifest: `manifest.json` (inside each tarball) describes
  the exact toolchain and build flags. See [Toolchain Pinning](../../guides/toolchains/).
