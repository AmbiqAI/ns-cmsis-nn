...
description: Operator families, data types, and the acceleration paths behind them.
---
...
API reference described in [API](../../reference/). To search the kernels
themselves by name, family, data type, or header, use the
[Kernel index](../../reference/kernel-index/). For the data types each family
carries, see [Data types by family](../data-types-by-family/).
