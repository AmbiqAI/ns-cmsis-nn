---
title: Contributing
description: Branching, conventional commits, the release flow, hooks, and formatting.
---
...
[Required vs optional assets](../guides/releases/#required-vs-optional-assets)
...
[Recovering assets for an existing tag](../guides/releases/#recovering-assets-for-an-existing-tag));
