...
## [7.31.0](https://github.com/AmbiqAI/ns-cmsis-nn/compare/v7.33.1...v7.31.0) (2026-09-10)
...
* add int16 rsqrt kernels and generated tests ([9a7d351](https://github.com/AmbiqAI/ns-cmsis-nn/commit/9a7d351e8c5c9bfd2c640abe3d2976cd2730f112))
...
* Add resize nearest neighbor op ([c35f844](https://github.com/AmbiqAI/ns-cmsis-nn/commit/c35f844e7e2372a7b2c03dacce5bf52e7d4e9397))
* Add Resize Nearest Neighbor Operator ([3c49c3f](https://github.com/AmbiqAI/ns-cmsis-nn/commit/3c49c3f41b522c29532c768be58e6e68527ee607))
...
* add workflow to update helia-core-tester submodule and create pull request for latest release ([e003899](https://github.com/AmbiqAI/ns-cmsis-nn/commit/e003899ef666c158bc71d01c335375e629d430aa))
...
* enhance CI workflows to require explicit container image input and improve image resolution logic ([e38e64a](https://github.com/AmbiqAI/ns-cmsis-nn/commit/e38e64a0278c064fda1ace25634c69f83f41ee87))
...
* refactor workflow inputs and update image tagging in CI/CD pipelines ([ab983de](https://github.com/AmbiqAI/ns-cmsis-nn/commit/ab983de506d0ade6b4f54d797f92305b7567e6fa))
...
* rename workflows, pin container images, add versioned docker tags ([df24617](https://github.com/AmbiqAI/ns-cmsis-nn/commit/df2461720f750c6bfc2f16097500d0df7badb63a))
...
* update Dockerfile and workflows for improved CI image tagging and release process ([184e50b](https://github.com/AmbiqAI/ns-cmsis-nn/commit/184e50b488c96877981836467fea802635b40361))
...
* Add GCC 15/Zephyr compatibility shim for vldrwq_s32() MVE intrinsic ([2d43de7](https://github.com/AmbiqAI/ns-cmsis-nn/commit/2d43de78a67a5e4b7d4c7e890ece733052792752))
* Add GCC 15/Zephyr compatibility shim for vldrwq_s32() MVE intrinsic ([55ea0eb](https://github.com/AmbiqAI/ns-cmsis-nn/commit/55ea0eba655d7a7557601a24e95c27b21a074860))
...
* add step to mark workspace as a safe git directory in helia-core-tester workflow ([1bdf035](https://github.com/AmbiqAI/ns-cmsis-nn/commit/1bdf03508d4d84f2c747c9b6010d26f6928cef42))
...
* align int16 rsqrt input offset handling ([0913c29](https://github.com/AmbiqAI/ns-cmsis-nn/commit/0913c2905166f0c5235df1a85517f38cd3cf1e26))
...
* ci workflow. add Core and Core tester tags to the docker image. next is to build once and use every PR ([d01d7ba](https://github.com/AmbiqAI/ns-cmsis-nn/commit/d01d7bac20fbfd811f77c292aa7d78f70ca3c042))
...
* Correct arm_sub_s8/s16 broadcast bug ([055e0a5](https://github.com/AmbiqAI/ns-cmsis-nn/commit/055e0a5b2c3759a17b509df9f37727ebcdd68e04))
* Correct arm_sub_s8/s16 broadcast bug ([5216e48](https://github.com/AmbiqAI/ns-cmsis-nn/commit/5216e484d21a2fe48ee3036848e11dd18b791bed))
...
* expand truncated NS-CMS… entry in CHANGELOG.md to full NS-CMSIS-NN text ([35b181c](https://github.com/AmbiqAI/ns-cmsis-nn/commit/35b181cd88b17378f51e9b7ed0aab1151b115ca9))
...
* include arm_elementwise_add_fp16.c in target_sources ([1b943e0](https://github.com/AmbiqAI/ns-cmsis-nn/commit/1b943e0c6e22162f9600528180ec1fb8044100c6))
* jobs: ([5a2a989](https://github.com/AmbiqAI/ns-cmsis-nn/commit/5a2a989c2727926560c9cfd69a57b4297b83933d))
...
* no hct docker image. fix tag and add workflow to update hct tag weekly ([02b7bb4](https://github.com/AmbiqAI/ns-cmsis-nn/commit/02b7bb4487cb257fb03e91fe1b515cf8bcb9efe6))
...
* Reformat to match clang-format output ([c4a20e5](https://github.com/AmbiqAI/ns-cmsis-nn/commit/c4a20e5e03a2e53f89b110cfe2a9af82bb2b0bcf))
...
* replace HTML-escaped &gt;= with inline code in CHANGELOG.md line 27 ([6532b03](https://github.com/AmbiqAI/ns-cmsis-nn/commit/6532b0322822570dd2052d2d368a03719d4a33c4))
...
* strip Prebuilt component from PDSC when prebuilt libs not staged ([a7e970c](https://github.com/AmbiqAI/ns-cmsis-nn/commit/a7e970ca3373ac5a0ca99ed3db69ad0bf4d7b816))
...
* update container image reference in workflows to use inputs directly ([df501ab](https://github.com/AmbiqAI/ns-cmsis-nn/commit/df501abb25f32b78ff789233550818ef005ecd49))
...
* improve FP32 and FP16 ReduceSum traversal ([#488](https://github.com/AmbiqAI/ns-cmsis-nn/issues/488)) ([96d293c](https://github.com/AmbiqAI/ns-cmsis-nn/commit/96d293c23cf5765b5d2f0dec66c4eb7729acae38))
...
* remove legacy int16 rsqrt entry point ([1a58925](https://github.com/AmbiqAI/ns-cmsis-nn/commit/1a589250ffd10aed95fc2b11a85f0bfa6f7d93ea))
* remove RunnersStep ([d6ff29a](https://github.com/AmbiqAI/ns-cmsis-nn/commit/d6ff29affbfed412ccb4b148a83836a0ffd5889b))
* remove unused logger setup and streamline header retrieval in test runner generation ([03d41bd](https://github.com/AmbiqAI/ns-cmsis-nn/commit/03d41bd19f0b62458b919abb1ba1baa44357a716))
